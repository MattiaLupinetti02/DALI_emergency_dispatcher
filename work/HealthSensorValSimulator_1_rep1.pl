...
random_patient(var_P):-patient_list(var_List),length(var_List,var_L),random(0,var_L,var_Index),nth0(var_Index,var_List,var_P).

send_random_hr(var_P,var_HR):-random_patient(var_P),random_hr(var_HR),write('generato paziente '),write(var_P),write(' e hr '),write(var_HR),nl.

evi(send_random_hr(var_P,var_HR)):-a(message(var_HealthSensor1_rep1,send_message(new_hr(var_P,var_HR),var_Me))).

random_o(var_OO):-random(var_NUM),var_OO is 84+integer(var_NUM*10).

send_random_o(var_P,var_OO):-random_patient(var_P),random_o(var_OO),write('generato paziente '),write(var_P),write(' e O2 '),write(var_OO),nl.

evi(send_random_o(var_P,var_OO)):-a(message(var_HealthSensor1_rep1,send_message(new_oo(var_P,var_OO),var_Me))).
...
call_cfp(var_A,var_C,var_Ag):-clause(agent(var_AgI),var__),clause(ext_agent(var_Ag,_326137,var_Ontology,_326141),_326131),asserisci_ontologia(var_Ag,var_Ontology,var_A),once(call_meta_execute_cfp(var_A,var_C,var_Ag,_326175)),a(message(var_Ag,propose(var_A,[_326175],var_AgI))),retractall(ext_agent(var_Ag,_326213,var_Ontology,_326217)).

call_propose(var_A,var_C,var_Ag):-clause(agent(var_AgI),var__),clause(ext_agent(var_Ag,_326011,var_Ontology,_326015),_326005),asserisci_ontologia(var_Ag,var_Ontology,var_A),once(call_meta_execute_propose(var_A,var_C,var_Ag)),a(message(var_Ag,accept_proposal(var_A,[],var_AgI))),retractall(ext_agent(var_Ag,_326081,var_Ontology,_326085)).

call_propose(var_A,var_C,var_Ag):-clause(agent(var_AgI),var__),clause(ext_agent(var_Ag,_325899,var_Ontology,_325903),_325893),not(call_meta_execute_propose(var_A,var_C,var_Ag)),a(message(var_Ag,reject_proposal(var_A,[],var_AgI))),retractall(ext_agent(var_Ag,_325955,var_Ontology,_325959)).
...
call_cancel(var_A,var_Ag):-if(clause(high_action(var_A,var_Te,var_Ag),_325463),retractall(high_action(var_A,var_Te,var_Ag)),true),if(clause(normal_action(var_A,var_Te,var_Ag),_325497),retractall(normal_action(var_A,var_Te,var_Ag)),true).
...
refused_message(var_To,var_M):-clause(eliminated_message(var_M,var_To,motivation(conditions_not_verified)),_325279).
...
send_jasper_return_message(var_X,var_S,var_T,var_S0):-clause(agent(var_Ag),_325127),a(message(var_S,send_message(sent_rmi(var_X,var_T,var_S0),var_Ag))).

gest_learn(var_H):-clause(past(learn(var_H),var_T,var_U),_325075),learn_if(var_H,var_T,var_U).

evi(gest_learn(var_H)):-retractall(past(learn(var_H),_324951,_324953)),clause(agente(_324973,_324975,_324977,var_S),_324969),name(var_S,var_N),append(var_L,[46,112,108],var_N),name(var_F,var_L),manage_lg(var_H,var_F),a(learned(var_H)).

cllearn:-clause(agente(_324745,_324747,_324749,var_S),_324741),name(var_S,var_N),append(var_L,[46,112,108],var_N),append(var_L,[46,116,120,116],var_To),name(var_FI,var_To),open(var_FI,read,_324845,[]),repeat,read(_324845,var_T),arg(1,var_T,var_H),write(var_H),nl,var_T==end_of_file,!,close(_324845).
