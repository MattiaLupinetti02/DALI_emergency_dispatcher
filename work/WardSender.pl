...
evi(leggi_tutte_le_mappe):-open('reparti',read,var_Stream),leggi_e_stampa_mappe_da_stream(var_Stream),close(var_Stream),set_done(1).

leggi_tutte_le_mappe:-done(var_X),var_X==0.

leggi_e_stampa_mappe_da_stream(var_Stream):-read(var_Stream,var_Termine),(var_Termine==end_of_file->true;var_Termine=reparto(var_NomeReparto,var_Lista)->atom_concat('Coord_',var_NomeReparto,var_CoordName),a(message(var_CoordName,send_message(ward(var_Lista),var_Me))),leggi_e_stampa_mappe_da_stream(var_Stream)).

set_done(var_Val):-retractall(done(var__)),assertz(done(var_Val)).
...
call_cfp(var_A,var_C,var_Ag):-clause(agent(var_AgI),var__),clause(ext_agent(var_Ag,_318703,var_Ontology,_318707),_318697),asserisci_ontologia(var_Ag,var_Ontology,var_A),once(call_meta_execute_cfp(var_A,var_C,var_Ag,_318741)),a(message(var_Ag,propose(var_A,[_318741],var_AgI))),retractall(ext_agent(var_Ag,_318779,var_Ontology,_318783)).

call_propose(var_A,var_C,var_Ag):-clause(agent(var_AgI),var__),clause(ext_agent(var_Ag,_318577,var_Ontology,_318581),_318571),asserisci_ontologia(var_Ag,var_Ontology,var_A),once(call_meta_execute_propose(var_A,var_C,var_Ag)),a(message(var_Ag,accept_proposal(var_A,[],var_AgI))),retractall(ext_agent(var_Ag,_318647,var_Ontology,_318651)).

call_propose(var_A,var_C,var_Ag):-clause(agent(var_AgI),var__),clause(ext_agent(var_Ag,_318465,var_Ontology,_318469),_318459),not(call_meta_execute_propose(var_A,var_C,var_Ag)),a(message(var_Ag,reject_proposal(var_A,[],var_AgI))),retractall(ext_agent(var_Ag,_318521,var_Ontology,_318525)).
...
call_cancel(var_A,var_Ag):-if(clause(high_action(var_A,var_Te,var_Ag),_318029),retractall(high_action(var_A,var_Te,var_Ag)),true),if(clause(normal_action(var_A,var_Te,var_Ag),_318063),retractall(normal_action(var_A,var_Te,var_Ag)),true).
...
refused_message(var_To,var_M):-clause(eliminated_message(var_M,var_To,motivation(conditions_not_verified)),_317845).
...
send_jasper_return_message(var_X,var_S,var_T,var_S0):-clause(agent(var_Ag),_317693),a(message(var_S,send_message(sent_rmi(var_X,var_T,var_S0),var_Ag))).

gest_learn(var_H):-clause(past(learn(var_H),var_T,var_U),_317641),learn_if(var_H,var_T,var_U).

evi(gest_learn(var_H)):-retractall(past(learn(var_H),_317517,_317519)),clause(agente(_317539,_317541,_317543,var_S),_317535),name(var_S,var_N),append(var_L,[46,112,108],var_N),name(var_F,var_L),manage_lg(var_H,var_F),a(learned(var_H)).

cllearn:-clause(agente(_317311,_317313,_317315,var_S),_317307),name(var_S,var_N),append(var_L,[46,112,108],var_N),append(var_L,[46,116,120,116],var_To),name(var_FI,var_To),open(var_FI,read,_317411,[]),repeat,read(_317411,var_T),arg(1,var_T,var_H),write(var_H),nl,var_T==end_of_file,!,close(_317411).
